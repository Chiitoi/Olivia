...
export const MESSAGES = {
    INFO: {
        ...
        NAME_LIMIT: EMBEDS.INFO('Provided emoji names have a maximum limit of 32 characters.'),
    ...
    ERRORS: {
        ...
        EMOJI: EMBEDS.ERROR(`Unable to add custom emoji. Please DM Flare#2851 with the emote or image link.`),
